<tr class="recipeRow" id="row_<?php echo $rowNum; ?>">
    <td class="ui-widget-content">
        <?php
        echo $this->Form->input($modelName.'.recipes.' . $rowNum . '.name',
    ...
    <td class="ui-widget-content">
        <?php
        echo $this->Form->input($modelName.'.recipes.' . $rowNum . '.servings',
    ...
    <td class="ui-widget-content">
        <?php
        echo $this->Form->input($modelName.'.recipes.' . $rowNum . '.description',
                array('div' => false,
                    'label' => false,
                    'class' => 'ui-widget-content'));
        ?>
    ...
    <td class="ui-widget-content">
        ...
        echo $html->link('view',
                array(
                    'controller'=>'recipes', 
                    'action' => 'view',
                    $this->data[$modelName]['recipes'][$rowNum]['name']
                ), // should be id
                array(
